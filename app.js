...
var db = require('./db');
var app = express();
var dashboadRouter = require('./controller/dashboardController')
var yogaRouter = require('./controller/yogaController')
var zumbaRouter = require('./controller/zumbaController')
var cardioRouter = require('./controller/cardioController')
var strengthRouter = require('./controller/strengthController')
